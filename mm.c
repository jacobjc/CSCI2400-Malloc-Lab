...
static char *rover;                             //ADDED TO CODE
...
//Some code implementation borrowed from Computer Systems A Programmer’s Perspective
// by Randal E. Bryant - Carnegie Mellon University & David R. O’Hallaron - Carnegie Mellon University and Intel Labs
...
int mm_init(void){
  ...
  rover = heap_listp; //rover initialization
...
/* Coalesce if the previous block was free */ //coalesce means come together or form one mass or whole
  return coalesce(bp);
}
